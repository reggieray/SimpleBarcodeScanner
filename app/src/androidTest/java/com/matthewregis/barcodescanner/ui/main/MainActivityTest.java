...
public class MainActivityTest {
    ...
    @Test
    public void ShouldHaveFabButtonsTest() {
    ...
    @Test
    public void ShouldShowBarcodeInputOn() {
        ...
        try {
            ...
            //proceed. this is the helper text
        }
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.md_title), withText("Barcode input"), isDisplayed()));
        textView.check(matches(withText("Barcode input")));
